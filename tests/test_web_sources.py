...
def test_web_date_parser_supports_portuguese_and_iso_dates():
...
def test_extract_web_article_prefers_jsonld_metadata():
    ...
    <html>
      <head>
        <meta property="article:published_time" content="2024-04-05T10:00:00-03:00">
        <script type="application/ld+json">
        {
          ...
          "articleBody": "Conteúdo jurídico " + "relevante " * 200
        }
        </script>
      </head>
      <body>
        <main>
          <article>
            ...
            <p>Conteúdo jurídico sobre licitações públicas.</p>
            <p>""" + "Texto substantivo do artigo. " * 120 + """</p>
          </article>
        </main>
      </body>
    </html>
