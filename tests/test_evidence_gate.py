...
def test_evidence_gate_accepts_inflectional_paraphrase():
    source = make_point(
        "lei14133",
        "artigo:1",
        "A Administração deverá planejar, documentar, controlar e fiscalizar continuamente os procedimentos internos, formais, auditáveis e permanentes, garantindo transparência e eficiência.",
    )
    assert validate_generated_answer(
