...
Além dos resultados temáticos, o batch coleta separadamente as **Súmulas do TCU e do TCESP**, cada enunciado como registro estruturado individual a partir dos catálogos oficiais consolidados. Quando o catálogo do TCU for entregue por uma aplicação renderizada, o coletor usa Chromium para obter o conteúdo efetivamente exibido. Súmulas não são contabilizadas no alvo de acórdãos por tribunal.
