...
SOURCES = [
    ...
    _federal("in5-2017", "IN SEGES/MP nº 5/2017 — contratação de serviços sob execução indireta", "https://www.gov.br/compras/pt-br/acesso-a-informacao/legislacao/instrucoes-normativas/instrucao-normativa-seges-no-5-de-26-de-maio-de-2017", tipo_documento="instrucao_normativa", required=True),
