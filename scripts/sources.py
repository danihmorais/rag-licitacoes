...
SOURCES = [
    ...
    _federal("tcu", "TCU — Licitações e Contratos: orientações e jurisprudência", "https://portal.tcu.gov.br/publicacoes-institucionais/cartilha-manual-ou-tutorial/licitacoes-e", tipo_documento="manual", source_role="jurisprudencia_controle", authority_level=2, tribunal="TCU", follow_links=True, follow_patterns=(r"\\.pdf(?:$|\\?)",), max_follow=20),
    _sp("tcesp", "TCESP — Súmulas e Boletim de Jurisprudência", "https://www.tce.sp.gov.br/boletim-de-jurisprudencia/sumulas", tipo_documento="sumula", source_role="jurisprudencia_controle", authority_level=2, tribunal="TCESP", required=True, follow_links=True, follow_patterns=(r"\\.pdf(?:$|\\?)",), max_follow=20),
