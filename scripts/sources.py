...
SOURCES = [
    ...
    _federal("tcu-manual-licitacoes", "TCU — Licitações e Contratos: Orientações e Jurisprudência", "https://portal.tcu.gov.br/data/files/16/04/09/B2/2DEB19104CE08619E18818A8/Licitacoes-e-Contratos-Orientacoes-e-Jurisprudencia-do-TCU-5a-Edicao.pdf", tipo_documento="manual", required=True, source_role="orientacao_oficial", authority_level=3, ramo_direito="Contratações Públicas", data_versao="5ª edição"),
    ...
    _federal("lei12846", "Lei nº 12.846/2013 — Lei Anticorrupção", "https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2013/lei/l12846.htm", fallback_urls=("https://www2.camara.leg.br/legin/fed/lei/2013/lei-12846-1-agosto-2013-776664-norma-pl.html",)),
